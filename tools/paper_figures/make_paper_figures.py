...
def fig8(outdir, dpi):
    ...
    # 相邻过近的点(G1 0.908、G2 0.915、G3 0.910)把标签放到点的侧方(与点同高),
    # 在上游 v2 偏移基础上微调,消除标签与折线/标签的重叠
    off = {(0, 0): (0, 8),   (0, 1): (0, -15), (0, 2): (-12, 8),  (0, 3): (-24, -4),
           (1, 0): (0, 8),   (1, 1): (0, -15), (1, 2): (-24, -4), (1, 3): (0, -15),
           (2, 0): (0, 8),   (2, 1): (24, -4), (2, 2): (0, -15),  (2, 3): (0, 8)}
